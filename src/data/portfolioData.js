...
export const portfolioItems = [
    ...
    projects: [
      {
        ...
        links: [
          { label: "GITHUB", url: "https://github.com/bagaskara0506/E-Commerce_Data_Analysis.git" },
          { label: "DATA STUDIO", url: "https://datastudio.google.com/reporting/1a808948-4b81-45cb-a9c1-5cd7950ee41b" },
          { label: "MEDIUM", url: "https://medium.com/@satriadevopsindonesia/data-analysis-e-commerce-growth-business-performance-rfm-analysis-of-olist-store-dfd44fac4785" },
        ],
      ...
      },
      {
        ...
        links: [
          { label: "GITHUB", url: "https://github.com/bagaskara0506/AdventureWorks_Inventory_and_Performance.git" },
          { label: "TABLEAU", url: "https://public.tableau.com/app/profile/satria.bagaskara4685/viz/AdventureWorksInventoryProductPerformanceDashboard/DashboardAdventureWorks-Analysis" },
          { label: "MEDIUM", url: "https://medium.com/@satriadevopsindonesia/adventureworks-inventory-product-performance-analysis-b08aeea4251c" },
        ],
      ...
      },
      {
        ...
        links: [
          { label: "GITHUB", url: "https://github.com/bagaskara0506/BPJS_Inpatient_Analytics.git" },
          { label: "MEDIUM", url: "https://medium.com/@satriadevopsindonesia/analysis-of-bpjs-diagnosis-and-its-relationship-with-operational-financial-and-policy-aspects-48103018ac67" },
        ],
      ...
      },
      {
        ...
        links: [
          { label: "GITHUB", url: "https://github.com/bagaskara0506/Hemodialysis_Financial_Analytics.git" },
          { label: "TABLEAU", url: "https://public.tableau.com/app/profile/satria.bagaskara4685/viz/Hemodialysis_Analytics/DashboardPilar4-ServiceOperationsAnalytics?publish=yes" },
          { label: "MEDIUM", url: "https://medium.com/@satriadevopsindonesia/surprising-findings-about-hemodialysis-treatment-services-6ea0d8b79f3a" },
        ],
      ...
      },
      {
        ...
        links: [
          { label: "GITHUB", url: "https://github.com/bagaskara0506/RS_Sentiment_Analysis.git" },
          { label: "TABLEAU", url: "https://public.tableau.com/app/profile/satria.bagaskara4685/viz/RS_Sentiment_Analysis/HOSPITALPATIENTSENTIMENTANALYSIS" },
          { label: "MEDIUM", url: "https://medium.com/@satriadevopsindonesia/hospital-patient-sentiment-analysis-using-the-google-maps-review-data-scraping-method-de76755d8c2e" },
        ],
  ...
  },
  {
    ...
    links: [],
    documentation: [
      { image: "/images/image26.jpg", title: "MonEv RSUD Gema Santi Nusa Penida", date: "04 – 06 Mei 2026" },
      { image: "/images/image22.jpg", title: "MonEv RST Dompet Dhuafa", date: "14 April 2026" },
      { image: "/images/image28.jpg", title: "Monev Klinik Hanuro", date: "29 April 2026" },
      { image: "/images/image30.png", title: "Monev KPRI Kita", date: "11 Mei 2026" },
    ],
  },
  {
    id: 3,
